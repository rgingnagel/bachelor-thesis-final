...
Rechts bovenin zie je een tabel die de specifieke aantallen laat zien. Rechts onderin zie je een staaf grafiek die laat zien hoe de oplossingen in de stad en in de rest van Nederland verdeeld zijn. **Hover** met de muis over de staaf grafiek om de precieze procenten te zien. Door te slepen en klikken kan je de grafiek aanpassen.

[Bron: Lerarentekortisnu.nl](https://lerarentekortisnu.nl/)
''', className='container',
    ...
    dcc.Markdown('''[Bron: Rijksoverheid 2018](https://www.rijksoverheid.nl/onderwerpen/werken-in-het-onderwijs/aanpak-tekort-aan-leraren/lerarentekort-primair-onderwijs)'''),
